  ...
  return (
    <section className="bg-hero-gradient py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        {/* Music Player Card with Paper Texture */}
        <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border-2 border-secondary/30 overflow-hidden">
          {/* Paper Texture Overlay */}
          <div 
            className="absolute inset-0 pointer-events-none rounded-2xl opacity-[0.15]"
            style={{
          ...
          <div className="relative z-10">
            ...
            <div className="mt-6 pt-5 border-t border-secondary/20">
              <button
                ...
                className="w-full px-6 py-3 bg-gradient-to-r from-[#1DB954] to-[#1ed760] hover:from-[#1ed760] hover:to-[#1DB954] text-white font-bold rounded-full transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
              >
